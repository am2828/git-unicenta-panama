...
INSERT INTO TAXCUSCATEGORIES(ID, NAME) VALUES ('000', 'EXENTO');
...
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('001', 'ITBMS');
...
CREATE TABLE TAXES (
    ...
    RATEORDER INTEGER,
    VALIDFROM TIMESTAMP NOT NULL DEFAULT '2001-01-01 00:00:00'::timestamp,
    PRIMARY KEY (ID),
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', 'ITBMS', '001', NULL, NULL, 0.07, FALSE, NULL);
...
CREATE TABLE CLOSEDCASH (
    ...
    PERSON VARCHAR DEFAULT '' NOT NULL,
...
INSERT INTO FLOORS(ID, NAME, IMAGE) VALUES ('0', 'Piso del Restaurant', $FILE{/com/openbravo/pos/templates/restaurant_floor.png});
...
INSERT INTO BREAKS(ID, NAME, VISIBLE, NOTES) VALUES ('0', 'Almuerzo', TRUE, NULL);
INSERT INTO BREAKS(ID, NAME, VISIBLE, NOTES) VALUES ('1', 'Descanso Tarde', TRUE, NULL);
INSERT INTO BREAKS(ID, NAME, VISIBLE, NOTES) VALUES ('2', 'Descanso Mañana', TRUE, NULL);
