...
public class Order implements java.io.Serializable {
    ...
    private com.openbravo.pos.erp.externalsales.BPartner businessPartner;
    private com.openbravo.pos.erp.externalsales.OrderLine[] lines;
    private com.openbravo.pos.erp.externalsales.OrderIdentifier orderId;
    private com.openbravo.pos.erp.externalsales.Payment[] payment;
    private int state;
    ...
    public Order(
            com.openbravo.pos.erp.externalsales.BPartner businessPartner,
            com.openbravo.pos.erp.externalsales.OrderLine[] lines,
            com.openbravo.pos.erp.externalsales.OrderIdentifier orderId,
            com.openbravo.pos.erp.externalsales.Payment[] payment,
            int state) {
     ...
     */
    public com.openbravo.pos.erp.externalsales.BPartner getBusinessPartner() {
        return businessPartner;
    }
     ...
     */
    public void setBusinessPartner(com.openbravo.pos.erp.externalsales.BPartner businessPartner) {
        this.businessPartner = businessPartner;
    }
     ...
     * @return lines
     */
    public com.openbravo.pos.erp.externalsales.OrderLine[] getLines() {
        return lines;
    }
     ...
     * @param lines
     */
    public void setLines(com.openbravo.pos.erp.externalsales.OrderLine[] lines) {
        this.lines = lines;
    }
     ...
     * @return orderId
     */
    public com.openbravo.pos.erp.externalsales.OrderIdentifier getOrderId() {
        return orderId;
    }
     ...
     * @param orderId
     */
    public void setOrderId(com.openbravo.pos.erp.externalsales.OrderIdentifier orderId) {
        this.orderId = orderId;
    }
     ...
     * @return payment
     */
    public com.openbravo.pos.erp.externalsales.Payment[] getPayment() {
        return payment;
    }
     ...
     * @param payment
     */
    public void setPayment(com.openbravo.pos.erp.externalsales.Payment[] payment) {
        this.payment = payment;
    }
