...
import com.openbravo.pos.erp.externalsales.BPartner;
    ...
    public MessageInf execute() throws BasicException {        
        ...
        try {
            ...
            if (ticketlist.size() == 0) {
                ...
                // transformed tickets on orders -- red1 extract XML for I_Order - take only up to Orderline, ignore payment[] of tenderType[]
            	//set Parameters from openbravo.properties
            	MQClient.setParams(ExternalSalesHelper.MQueueHost, ExternalSalesHelper.MQueuePORT, ExternalSalesHelper.OrdersQueue);
	            ...
	            for (int j = 0; j < ticket.getLines().size(); j++){
	                ...
	                //red1 - convert to XML
	           		if (bp!=null) {
	  		      	...
	  		      	writer.writeCharacters(ExternalSalesHelper.m_iERPId);
	  		      	writer.writeEndElement(); 

	  		      	writer.writeStartElement("POSLocatorName"); 
	  		      	writer.writeCharacters(ExternalSalesHelper.m_iERPPos);
	  		      	writer.writeEndElement(); 
